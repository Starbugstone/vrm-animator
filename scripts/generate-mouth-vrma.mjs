...
const CLIPS = [
  ...
  },
  {
    ...
    channels: {
      happy: {
        times: [0, 0.18, 0.42, 0.78, 1.16, 1.52],
        weights: [0, 0.58, 0.72, 0.68, 0.34, 0],
      },
      relaxed: {
        times: [0, 0.22, 0.54, 0.92, 1.3, 1.52],
        weights: [0.04, 0.18, 0.26, 0.24, 0.12, 0],
      },
      ee: {
        times: [0, 0.2, 0.48, 0.84, 1.18, 1.52],
        weights: [0, 0.14, 0.22, 0.18, 0.08, 0],
      },
      lookUp: {
        times: [0, 0.34, 0.76, 1.1, 1.52],
        weights: [0.02, 0.08, 0.12, 0.06, 0],
      },
      blink: {
        times: [0, 1.0, 1.1, 1.22, 1.52],
        weights: [0, 0, 0.42, 0, 0],
      },
    },
  },
  {
  ...
  },
  {
    ...
    channels: {
      happy: {
        times: [0, 0.12, 0.34, 0.7, 1.02, 1.32],
        weights: [0.06, 0.26, 0.34, 0.3, 0.12, 0],
      },
      blink: {
        times: [0, 0.14, 0.24, 0.38, 0.6, 1.32],
        weights: [0, 0.18, 0.82, 0.28, 0, 0],
      },
      lookRight: {
        times: [0, 0.2, 0.52, 0.86, 1.14, 1.32],
        weights: [0.04, 0.18, 0.26, 0.18, 0.08, 0],
      },
      ee: {
        times: [0, 0.18, 0.44, 0.82, 1.1, 1.32],
        weights: [0.02, 0.12, 0.18, 0.14, 0.06, 0],
      },
      relaxed: {
        times: [0, 0.24, 0.58, 0.94, 1.32],
        weights: [0.02, 0.1, 0.18, 0.1, 0],
      },
    },
  },
]
